...
temp->prev = NULL;
temp->next = NULL;
printf("\n Enter ssn,name,department, designation, salary and
phno of employee : \n");
...
case 6:deletebeg();
break;
case 7: printf("\nTo show DLL as Queue,\n1. Perform insert and deletion operations by calling
insertbeg() and deleteend() respectively.\n \tOR \n 2. Perform insert and deletion operations by
calling insertend() and deletebeg() respectively\n");
break;
case 8: exit(0);
