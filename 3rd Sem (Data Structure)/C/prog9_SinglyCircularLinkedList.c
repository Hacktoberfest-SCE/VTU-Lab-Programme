...
typedef struct node* poly1;

poly1 attach(int c, int x, int y, int z, poly1 head)
{
	poly1 temp, cur;
...
poly1 add(poly1 first, poly1 sec, poly1 res)
{
	poly1 a, b;
